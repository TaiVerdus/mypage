-- ============================================================================
--  ⚠️ 这个脚本**本项目没有采用**（2026-09-24 用户决定直接用 WorkBuddy 云服务）。
--     真实的建表与权限见 `FEEDBACK.md` 第 3 节；这里的 SQL 与那边**逐句对应**，
--     留着的用处：① 讲解时能对照「Supabase 与 WorkBuddy 云服务其实是同一套概念」
--              ② 以后想切回 Supabase 时可以直接跑。
--

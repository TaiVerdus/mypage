...
var QUICK = [
  ...
  'Jarvis + EEG 是什么？',
  '这个主页是谁做的？',
  // 2026-09-26：随欢迎语那个梗一起加（答案「爱7。」由用户口述）
  '不爱品如爱谁？',
  // 2026-09-26（V4 首轮）：这两句是**真实访客问过的**（chat_questions 表），内容由用户口述补进事实档
  '你高中是哪里毕业的',
  '请介绍一下你的初中',
  // 2026-09-26：用户口述的「半个北京人半个天津人 / 最喜欢打篮球」
  '他是哪里人？',
  '他喜欢什么运动？',
  // 2026-09-26：用户口述了学院/大学 —— 这句是真实访客问过的（chat_questions 表里就有）
  '那就介绍一下你的大学',
  // 2026-09-26：用户确认「分身接的是我自己的 DeepSeek API」—— 这两句也是**真实访客问过的**
  '不接大模型了吗',
  '哦已经接大模型了？'
];
...
// ⚠️ 2026-09-26 起，「哪些话没人答得上」有了**数据来源**：`chat_questions` 表记下了访客的真实提问
//    （见 QUESTIONS.md）。流程固定为：查提问统计 → 挑出「高频 + 答不好/没料」的 → **先填进这里当标志位**
//    → **问用户该怎么回**（答案只能他给，我不代写）→ 他说完，写进 data/persona.json 的 about（离线）
//    与 facts（在线）→ 跑 tools/build-persona.py → 把问句从 KNOWN_GAP 挪进 QUICK。
var KNOWN_GAP = [];
...
var EXPECT = [
  ...
  ['他性格怎么样？', 'ENFJ'],
  ['你今年多大？', '大一在读'],
  // 2026-09-26（V4 首轮）：「介绍你自己」被补关键词时，宽泛的「介绍一下你」会抢走「请介绍一下你的初中」
  //  —— 这一行就是那次差点漏掉的守卫（QUICK 里只查「答上了」，查不出「答的是别的事」）
  ['介绍你自己', '数字分身'],
  ['请介绍一下你的初中', '第十九中学'],
  ['你高中是哪里毕业的', '英华'],
  ['他喜欢什么运动？', '篮球'],
  ['他是哪里人？', '北京人'],
  ['那就介绍一下你的大学', '未来技术学院'],
  ['不接大模型了吗', 'deepseek-flash'],
  ['哦已经接大模型了？', 'deepseek-flash']
];
var expectFail = [];
